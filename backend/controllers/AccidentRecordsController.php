...
use common\models\AccidentRecordsSearch;
...
/**
 * AccidentRecordsController implements the CRUD actions for AccidentRecords model.
 */
class AccidentRecordsController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all AccidentRecords models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new AccidentRecordsSearch();
    ...
    /**
     * Displays a single AccidentRecords model.
     * @param string $id
     * @return mixed
    ...
    /**
     * Creates a new AccidentRecords model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new AccidentRecords();
    ...
    /**
     * Updates an existing AccidentRecords model.
    ...
    /**
     * Deletes an existing AccidentRecords model.
    ...
    /**
     * Finds the AccidentRecords model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return AccidentRecords the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AccidentRecords::findOne($id)) !== null) {
            return $model;
        }
