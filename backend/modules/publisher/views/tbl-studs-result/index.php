...
<?= Html::beginForm(['/publisher/tbl-studs-result/result'], 'post'); ?>
    ...
    'filterModel' => $searchModel,
       ...
       'toolbar' =>  [
            ...
            ['content'=>
                ...
                'name' => 'submit', 'value' =>'Signed','onclick'=>'return confirm("Are you sure you want to rollback students result to dean? Click Ok to confirm.")']),
            ],

             ['content'=>
                Html::submitButton('Publish Students Result', ['class' => 'btn btn-primary float-right mr-4',
                'name' => 'submit', 'value' =>'publish','onclick'=>'return confirm("Are you sure you want to publish the selected result")']),
