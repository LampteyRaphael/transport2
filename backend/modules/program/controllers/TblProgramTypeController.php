...
use backend\modules\program\models\TblProgramTypeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * TblProgramTypeController implements the CRUD actions for TblProgramType model.
 */
class TblProgramTypeController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new TblProgramTypeSearch();
    ...
    {
        if (($model = TblProgramType::findOne($id)) !== null) {
            return $model;
        }
