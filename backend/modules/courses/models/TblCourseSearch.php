...
/**
 * TblCourseSearch represents the model behind the search form of `backend\modules\courses\models\TblCourse`.
 */
class TblCourseSearch extends TblCourse
{
    ...
    public function rules()
    {
        return [
            ...
            [['courseName', 'course_number', 'course_description', 'date', 'required_courses', 'created_at', 'updated_at'], 'safe'],
        ];
    }
