...
<!-- ['action' => Yii::$app->urlManager->createUrl(['/user/tbl-user/create'])] -->
    <?php $form = ActiveForm::begin(['action'=>Yii::$app->urlManager->createUrl(['/user/tbl-user/update'])]); ?>
    ...
    <div class="row">
        <div class="col">
            <?= Html::submitButton('Update', ['class' => 'btn btn-success float-right mr-5 btn-lg']) ?>
