...
/**
 * TblStRegistrationSearch represents the model behind the search form of `backend\modules\students\models\TblStRegistration`.
 */
class TblStRegistrationSearch extends TblStRegistration
{
    ...
    {
        return [
            [['id', 'stud_Id', 'program_id', 'acadamic_year', 'status', 'semester', 'courese_id'], 'integer'],
