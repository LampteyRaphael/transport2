...
use backend\modules\students\models\TblRegisCourse;

/**
 * TblRegisCourseSearch represents the model behind the search form of `backend\modules\students\models\TblRegisCourse`.
 */
