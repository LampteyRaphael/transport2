...
/* @var $searchModel common\models\TblStudsTranscriptSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Students Transcripts';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tbl-studs-transcript-index">

   
<?= Html::beginForm(['/transcript/tbl-studs-transcript/result'], 'post'); ?>
...
<?= GridView::widget([
    ...
    'filterModel' => $searchModel,
       ...
       'toolbar' =>  [
             ...
             ['content'=>
                Html::submitButton('Rollback Transcripts', ['class' => 'btn btn-primary float-right mr-4','data-confirm'=>'Are you sure you want to the selected result']),
            ],
   ...
   'floatHeader' => false,
   'panel' => [
       'heading'=>'<h3 class="panel-title">Students Transcripts</h3>',
