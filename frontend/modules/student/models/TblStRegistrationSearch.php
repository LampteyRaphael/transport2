...
/**
 * TblStRegistrationSearch represents the model behind the search form of `frontend\modules\student\models\TblStRegistration`.
 */
class TblStRegistrationSearch extends TblStRegistration
{
    ...
    {
        return [
            [['id', 'stud_Id', 'program_id', 'acadamic_year', 'status', 'semester', 'section_id', 'courese_id'], 'integer'],
