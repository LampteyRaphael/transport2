...
class TblStRegistration extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['stud_Id', 'program_id', 'acadamic_year', 'status', 'semester', 'section_id', 'date_o_regis', 'courese_id'], 'required'],
            [['stud_Id', 'program_id', 'acadamic_year', 'status', 'semester', 'section_id', 'courese_id'], 'integer'],
