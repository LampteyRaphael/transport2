...
<div class="row">
    ...
    <?= $form->field($model, 'vehicle_id')->widget(Select2::className(),[
           ...
           <?= $form->field($model, 'driver_id')->textInput(['value'=>Yii::$app->user->identity->id])?>
    ...
    <div class="col-6">
        ...
        <?= $form->field($model, 'trip_id')->widget(Select2::className(),[
                    ...
                    'options'=>['placeholder'=>'Trip Status'],
                    'language'=>'en',
                    'pluginOptions'=>[
                        'allowClear'=>true,
                    ]]) ?>
        ...
        <!-- < $form->field($model, 'assignmentCompletionTime')->hiddenInput()->label(false) ?> -->
