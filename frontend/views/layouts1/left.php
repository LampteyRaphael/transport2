                ...
                'items' => [
                    ...
                    [
                        'label' => 'USER',
                         ...
                         'url' => ['#'],
                         'items'=>[
                            ['label'=>'Users','icon'=>'','url'=>['/student/tbl-user/view']],
                            ['label' =>'General Info', 'icon'=>'circle-o', 'url' => ['/student/tbl-stud/view']],
                            ],
                    ],
                    ...
                    [
                        'label' => 'REGISTRATION',
                         ...
                         'url' => ['#'],
                         'items'=>[
                            // ['label'=>'Registered Courses', 'icon'=>'circle-o', 'url' => ['/student/tbl-st-registration/index']],
                            // ['label'=>'Register Courses', 'icon'=>'circle-o', 'url' => ['/student/tbl-course/index']],
                            // ['label'=>'Add And Drop','icon'=>'circle-o','url' => ['/user/tbl-user-log/index']],
