...
class TblStudPersDetails extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['last_name', 'title', 'first_name', 'gender', 'date_of_birth', 'nationality', 'contact_person', 'contact_number', 'date_apply'], 'required'],
            [['title'], 'integer'],
            [['date_of_birth', 'date_apply', 'created_at', 'updated_at'], 'safe'],
            [['last_name', 'first_name', 'middle_name', 'nationality'], 'string', 'max' => 255],
